//Código desarollado por Semi, https://wa.me/5493412529955)
let handler = async(m, {conn, text, participants}) => {
  ...
  conn.sendMessage(m.chat, {text: text ? text : "@puntoagu", mentions: participants.map(u => conn.decodeJid(u.id))}, {quoted: m})
  }} else if (m.quoted) {
